//ejemplo para crear animaciones en modulo matriz LED con Arduino basado en MAX7219
...
/**
 * Recibe un arreglo con la configuracion de 
...
/**
 * Muestra animacion con fantasma de PACMAN
**/
void animateGhost(){
  // limpiar la pantalla
  mx.clear();
