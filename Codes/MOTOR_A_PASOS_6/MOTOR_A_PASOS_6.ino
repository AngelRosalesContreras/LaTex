...
int velocidadMotor = 10;  // variable para determinar la velocidad
...
void sentidoHorario()  // en direccion de las agujas del reloj
{
  contadorPasos++;
...
void sentidoAntihorario()  // en direccion contraria a las agujas del reloj
{
  contadorPasos--;
